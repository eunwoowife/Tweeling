       ...
       <!--슬라이더이미지-->
        <div class="slideshow-container">
            ...
            <div class="mySlides fade">
              ...
              <img src="resources/image/wdw1.jpg" style="width:100%">
              <!-- <div class="text">Ariana Grande</div> -->
            </div>
      
            <div class="mySlides fade">
              <!-- <div class="numbertext">2 / 6</div> -->
              <img src="resources/image/wdw3.jpg" style="width:100%">
              <!-- <div class="text">Ariana Grande</div> -->
            </div>
      
            <div class="mySlides fade">
              <!-- <div class="numbertext">3 / 6</div> -->
              <img src="resources/image/wdw4.jpg" style="width:100%">
              <!-- <div class="text">Ariana Grande</div> -->
            </div>
      
            <div class="mySlides fade">
              <!-- <div class="numbertext">4 / 6</div> -->
              <img src="resources/image/wdw5.jpg" style="width:100%">
              <!-- <div class="text">Ariana Grande</div> -->
            </div>
      
            <div class="mySlides fade">
              <!-- <div class="numbertext">5 / 6</div> -->
              <img src="resources/image/wdw6.jpg" style="width:100%">
              <!-- <div class="text">Ariana Grande</div> -->
            </div>
      
            <div class="mySlides fade">
              <!-- <div class="numbertext">6 / 6</div> -->
              <img src="resources/image/wdw2.jpg" style="width:100%">
              <!-- <div class="text">Ariana Grande</div> -->
            </div>
              ...
              <br><br><br>
                ...
                <div class="content2">
                  <div class="category-list">
                      <ul id="cList">
                          <li>
                              <a href="<%=contextPath%>/wdwAllList.pro">ALL</a>
                              <br><br>
                          </li>
                          <li>
                              <a href="<%=contextPath%>/wdwMusicList.pro">MUSIC</a>
                              <br><br>
                          </li>
                          <li>
                              <a href="<%=contextPath%>/wdwClothingList.pro">CLOTHING</a>
                              <br><br>
                          </li>
                          <li>
                              <a href="<%=contextPath%>/wdwBeautyList.pro">BEAUTY</a>
                              <br><br>
                          </li>
                          <li>
                              <a href="<%=contextPath%>/wdwAccList.pro">ACC</a>
                              <br><br>
                          </li>
                      </ul>
                  </div>
