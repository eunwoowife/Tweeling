      ...
      <div class="inner">
        ...
        <div class="slideshow-container">
            ...
            <div class="mySlides fade">
              ...
              <img src="resources/image/dua.jpg" style="width:100%">
              <!-- <div class="text">Ariana Grande</div> -->
            </div>
      
            <div class="mySlides fade">
              <!-- <div class="numbertext">2 / 6</div> -->
              <img src="resources/image/dua3.jpg" style="width:100%">
              <!-- <div class="text">Ariana Grande</div> -->
            </div>
      
            <div class="mySlides fade">
              <!-- <div class="numbertext">3 / 6</div> -->
              <img src="resources/image/dua2.jpg" style="width:100%">
              <!-- <div class="text">Ariana Grande</div> -->
            </div>
      
            <div class="mySlides fade">
              <!-- <div class="numbertext">4 / 6</div> -->
              <img src="resources/image/dua4.jpg" style="width:100%">
              <!-- <div class="text">Ariana Grande</div> -->
            </div>
      
            <div class="mySlides fade">
              <!-- <div class="numbertext">5 / 6</div> -->
              <img src="resources/image/dua5.jpg" style="width:100%">
              <!-- <div class="text">Ariana Grande</div> -->
            </div>
      
            <div class="mySlides fade">
              <!-- <div class="numbertext">6 / 6</div> -->
              <img src="resources/image/dua6.jpg" style="width:100%">
              <!-- <div class="text">Ariana Grande</div> -->
            </div>
              ...
              <br><br><br>
                ...
                <div class="content2">
                  <div class="category-list">
                      <ul id="cList">
                          <li>
                              <a href="<%=contextPath%>/dlAllList.pro">ALL</a>
                              <br><br>
                          </li>
                          <li>
                              <a href="<%=contextPath%>/dlMusicList.pro">MUSIC</a>
                              <br><br>
                          </li>
                          <li>
                              <a href="<%=contextPath%>/dlClothingList.pro">CLOTHING</a>
                              <br><br>
                          </li>
                          <li>
                              <a href="<%=contextPath%>/dlBeautyList.pro">BEAUTY</a>
                              <br><br>
                          </li>
                          <li>
                              <a href="<%=contextPath%>/dlAccList.pro">ACC</a>
                              <br><br>
                          </li>
                      </ul>
                  </div>
