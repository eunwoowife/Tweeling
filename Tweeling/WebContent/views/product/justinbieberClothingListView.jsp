      ...
      <div class="inner">
        ...
        <div class="slideshow-container">
            ...
            <div class="mySlides fade">
              ...
              <img src="resources/image/justin1.jpg" style="width:100%">
              <!-- <div class="text">Ariana Grande</div> -->
            </div>
      
            <div class="mySlides fade">
              <!-- <div class="numbertext">2 / 6</div> -->
              <img src="resources/image/justin2.jpg" style="width:100%">
              <!-- <div class="text">Ariana Grande</div> -->
            </div>
      
            <div class="mySlides fade">
              <!-- <div class="numbertext">3 / 6</div> -->
              <img src="resources/image/justin3.jpg" style="width:100%">
              <!-- <div class="text">Ariana Grande</div> -->
            </div>
      
            <div class="mySlides fade">
              <!-- <div class="numbertext">4 / 6</div> -->
              <img src="resources/image/justin4.jpg" style="width:100%">
              <!-- <div class="text">Ariana Grande</div> -->
            </div>
      
            <div class="mySlides fade">
              <!-- <div class="numbertext">5 / 6</div> -->
              <img src="resources/image/justin5.jpg" style="width:100%">
              <!-- <div class="text">Ariana Grande</div> -->
            </div>
      
            <div class="mySlides fade">
              <!-- <div class="numbertext">6 / 6</div> -->
              <img src="resources/image/justin6.jpg" style="width:100%">
              <!-- <div class="text">Ariana Grande</div> -->
            </div>
          ...
          <div class="content1">
            <div class="products">
              ...
              <br><br><br>
                ...
                <div class="content2">
                  <div class="category-list">
                      <ul id="cList">
                          <li>
                              <a href="<%=contextPath%>/jbAllList.pro">ALL</a>
                              <br><br>
                          </li>
                          <li>
                              <a href="<%=contextPath%>/jbMusicList.pro">MUSIC</a>
                              <br><br>
                          </li>
                          <li>
                              <a href="<%=contextPath%>/jbClothingList.pro">CLOTHING</a>
                              <br><br>
                          </li>
                          <li>
                              <a href="<%=contextPath%>/jbBeautyList.pro">BEAUTY</a>
                              <br><br>
                          </li>
                          <li>
                              <a href="<%=contextPath%>/jbAccList.pro">ACC</a>
                              <br><br>
                          </li>
                      </ul>
                  </div>
              ...
              <div class="product-list">
                  ...
                  <%} %>
                  <%}else {%>
                  	<h2 align="center" style="color:red">등록된 상품이 없습니다.</h2>
                  	<%} %>
