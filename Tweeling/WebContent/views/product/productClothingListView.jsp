              ...
              <br><br><br>
                ...
                <div class="content2">
                  <div class="category-list">
                      <ul id="cList">
                          <li>
                              <a href="<%=contextPath%>/allList.pro">ALL</a>
                              <br><br>
                          </li>
                          <li>
                              <a href="<%=contextPath%>/musicList.pro">MUSIC</a>
                              <br><br>
                          </li>
                          <li>
                              <a href="<%=contextPath%>/clothingList.pro">CLOTHING</a>
                              <br><br>
                          </li>
                          <li>
                              <a href="<%=contextPath%>/beautyList.pro">BEAUTY</a>
                              <br><br>
                          </li>
                          <li>
                              <a href="<%=contextPath%>/accList.pro">ACC</a>
                              <br><br>
                          </li>
                      </ul>
                  </div>
