		...
		<!-- myPageTop 추가 시작 -->
			...
			<div class="myPageBottom">
                <div class="myPageContent">
                    ...
                    <br>
                    <form action="<%=contextPath %>/insert.question" id="enroll-form" method="post" enctype="multipart/form-data">
                    	<div class="enrollArea">
		                    ...
		                    <div class="qTypeArea"><!-- 질문 유형 -->
		                    	...
		                    	<select id="qType" name="qType" style="margin-bottom:10px; width: 150px; height: 25px;">
		                    		...
		                    		<option value="2" selected>결제문의</option>
		                    		<option value="3" selected>배송문의</option>
		                    		<option value="4" selected>이벤트문의</option>
		                    		<option value="5" selected>회원문의</option>
		                    	</select>
		                    </div>
		                    <br>
		                    <div class="qTitleArea">
		                    	<label for="qTitleInput" style="margin-right:20px;" id="qTitleSpan">- 문의 제목</label><input id="qTitleInput" name="qTitle" style="margin-bottom:20px; width:85%; height: 25px;" required>
		                    </div>
		                    <div class="qContentArea">
		                    	<textarea id="qContent" name="qContent" rows="40" cols="100" maxlength="1000" style="resize:none" required></textarea>
		                    </div>
		                    <br>
                    		...
                    		<br>
		                    <div class="qBtnArea">
								<span style="margin-right:20px;">글 작성</span><input type="submit" style="margin-right:50px;" class="submitBtn">
								<span style="margin-right:20px;">작성 취소</span><input type="reset" class="submitBtn">
								<br><br>
		                    </div>
						</div>
					</form>
