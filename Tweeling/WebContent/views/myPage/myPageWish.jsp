        ...
        <div class="myPageBody">
            ...
            <div class="myPageBottom">
                <div class="myPageContent">
                    ...
                    <span class="myPageMenuSpan" style=margin-right:70%;">&nbsp&nbsp관심 상품</span>
                    <!-- 
                ...
                <div class="myPageNavigator">
                    <div>
                        ...
                        <div>
                            ...
                            <li class="myPage-sub-li"><a class="myPage-a" href="<%=contextPath%>/wishList.mp"><b>&nbsp&nbsp&nbsp&nbsp&nbsp관심 상품</b></a></li>
